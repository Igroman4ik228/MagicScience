...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<UpgraderBlockEntity>> UPGRADER =
            BLOCK_ENTITIES.register("upgrader", () ->
                    BlockEntityType.Builder.of(UpgraderBlockEntity::new,
                            ModBlocks.UPGRADER.get()).build(null));
