...
public class CoreConfig {
    private static final @NotNull Map<CoreType, IBaseCoreConfig> CONFIGS = new EnumMap<>(CoreType.class);
    ...
    @NotNull
    public static IBaseCoreConfig get(@NotNull CoreType sectionType) {
