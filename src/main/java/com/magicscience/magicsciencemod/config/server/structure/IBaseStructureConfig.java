...
import com.magicscience.magicsciencemod.config.server.IAspectConfig;

public interface IBaseStructureConfig extends IAspectConfig<IMagicStructure, StructureTypes, BaseStructureData> {
}
