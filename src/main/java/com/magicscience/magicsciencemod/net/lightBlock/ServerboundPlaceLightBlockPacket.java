...
public class ServerboundPlaceLightBlockPacket {
    private final UUID particleUUID;
    private final BlockPos pos;

    public ServerboundPlaceLightBlockPacket(UUID particleUUID, BlockPos pos) {
        this.particleUUID = particleUUID;
        this.pos = pos;
    }

    public ServerboundPlaceLightBlockPacket(FriendlyByteBuf buf) {
